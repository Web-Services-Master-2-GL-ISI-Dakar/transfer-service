...
class OndmoneyTransactionEngineKafkaResourceIT {
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc
            .perform(get("/api/ondmoney-transaction-engine-kafka/register"))
        ...
        for (int i = 0; i < 100; i++) {
            ...
            if (content.contains("data:value-consume")) {
                restMockMvc.perform(get("/api/ondmoney-transaction-engine-kafka/unregister"));
                return;
            }
        }
