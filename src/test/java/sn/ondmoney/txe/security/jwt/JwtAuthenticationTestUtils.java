package sn.ondmoney.txe.security.jwt;

import static sn.ondmoney.txe.security.AuthoritiesConstants.ADMIN;
import static sn.ondmoney.txe.security.SecurityUtils.AUTHORITIES_CLAIM;
import static sn.ondmoney.txe.security.SecurityUtils.JWT_ALGORITHM;
